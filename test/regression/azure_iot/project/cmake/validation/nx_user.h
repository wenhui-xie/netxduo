...
/*
This file is a copy from https://github.com/azure-rtos/getting-started/blob/master/MXChip/AZ3166/lib/netxduo/nx_user.h
Nothing is changed except this comment to make sure the default configuration works.
*/
#ifndef NX_USER_H
#define NX_USER_H
